...
print(order_manager.list_orders()) # Output: [Order(order_id=1, items=[Item(name='Apple', price=0.5, quantity=2), Item(name='Banana', price=0.3, quantity=5)], discount_percent=0.1, total=3.45), Order(order_id=2, items=[Item(name='Laptop', price=800, quantity=1), Item(name='Mouse', price=20, quantity=2)], discount_percent=0.2, total=672.0)]
order_manager.apply_discount(1, 0.15)
print(order_manager.get_order_total(1)) # Output: 3.045