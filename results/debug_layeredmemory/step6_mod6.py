...
class Order:
    ...
    def __repr__(self):
        ...
        return f"Order(order_id={self.order_id}, items={self.items}, discount_percent={self.discount_percent}, total={self.total}, status={self.status}, created_at={self.created_at})"
...
if __name__ == '__main__':
    ...
    order1 = order_manager.add_order(1, [Item("Product A", 10.0, 1, 5)], inventory)
    order2 = order_manager.add_order(2, [Item("Product A", 10.0, 1, 5)], inventory)
    order_manager.cancel_order(1)

    try:
        payment = order_manager.process_payment(2, 10.0, "Credit Card")
