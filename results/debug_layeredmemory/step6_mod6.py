...
print(order_manager.get_order(2)) # Output: Order(order_id=2, items=[Item(name='Laptop', price=800, quantity=1), Item(name='Mouse', price=20, quantity=2)], discount_percent=0.0, status='CANCELLED')

print(order_manager.list_orders()) # Output: [Order(order_id=2, items=[Item(name='Laptop', price=800, quantity=1), Item(name='Mouse', price=20, quantity=2)], discount_percent=0.0, status='CANCELLED')]
...
shipped_orders = order_manager.get_orders_by_status(OrderStatus.SHIPPED)
for order in shipped_orders:
    print(order)

cancelled_orders = order_manager.get_orders_by_status(OrderStatus.CANCELLED)
