...
if __name__ == "__main__":
    ...
    try:
        is_overdue = system.check_overdue(1, "2023-12-01", "2024-01-15")
        overdue_amount = system.get_overdue_amount(1)
        print(f"Loan ID 1 is overdue: {is_overdue}")
    ...
    try:
        schedule = system.generate_payment_schedule(1)
        print("Payment Schedule:")
        for item in schedule:
            print(item)
        
        remaining_balance = system.get_remaining_balance(1, 12)  # Example: after 12 months
        print(f"Remaining balance after 12 months: {remaining_balance:.2f}원")
    except ValueError as e:
        print(e)