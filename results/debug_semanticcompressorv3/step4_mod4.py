...
class BudgetTracker:
    ...
    def cancel_transaction(self, tx_id: int) -> None:
        ...
        cancellation_tx_id = tx_id + 100000  # Unique cancellation transaction ID
        new_cancellation_transaction = Transaction(cancellation_tx_id, f"Cancellation of {transaction_to_cancel.tx_id}", -transaction_to_cancel.amount, transaction_to_cancel.date, transaction_to_cancel.category)
...
budget_tracker.set_budget_limit("식비", 500.00)
...
budget_tracker.update_transaction(1, description="Updated Groceries", amount=-25.00)
print("\nAfter updating Transaction ID 1:")
