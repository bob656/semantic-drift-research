...
class BudgetTracker:
    ...
    def cancel_transaction(self, tx_id: int) -> None:
        ...
        cancellation_tx_id = tx_id + 1000  # 예시로 새로운 취소 트랜잭션 ID 생성
        new_cancellation_transaction = Transaction(cancellation_tx_id, f"Cancellation of {tx_id}", -amount, date, category="취소")
