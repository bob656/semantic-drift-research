...
class OrderManager:
    def __init__(self, inventory: Inventory):
        ...
        self.customers: Dict[int, Customer] = {}  # Dictionary to store customers
    ...
    def add_order(self, order_id, items: List[Item], inventory: Inventory, customer_id: int):
